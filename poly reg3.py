...
dataset = pd.read_csv('regression3.csv')
...
Ay_pred = lin_reg.predict(AX)

AX_poly = poly_reg.fit_transform(AX)
...
pd.DataFrame(AXy).to_csv("LineRegResult3.csv")
pd.DataFrame(AXy_poly).to_csv("PolyRegResult3.csv")
